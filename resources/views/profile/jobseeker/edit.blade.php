            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h2 class="text-3xl font-semibold text-center mb-6">
                        <span class="text-black">Edit Your</span> <span class="text-pink-600">Profile</span>
                    </h2>

                    <form method="POST" action="{{ route('jobseeker.profile.update') }}" class="bg-pink-100 p-6 rounded-lg">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mt-6">
                            ...
                            <div id="universities-container">
                                @if($education->whereNotNull('university_name')->count() > 0)
